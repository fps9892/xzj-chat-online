...
**Nota**: Las reglas de Realtime Database están en modo abierto para desarrollo. Para producción, considera implementar reglas más restrictivas basadas en autenticación.
